...
#    $request_url = "https://maps.googleapis.com/maps/api/distancematrix/json?origins=" . urlencode($origin) . "&destinations=" . urlencode($destination) . "&mode=transit&key=AIzaSyAISZq1FmtMjGu6WAJmhkCkxNcYgZtYcWk";
     $request_url = "https://maps.googleapis.com/maps/api/distancematrix/json?origins=" . urlencode($origin) . "&destinations=" . urlencode($destination) . "&mode=transit&departure_time=" . $departEpoch . "&key=AIzaSyAISZq1FmtMjGu6WAJmhkCkxNcYgZtYcWk";
